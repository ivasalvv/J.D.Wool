...
function openTab(event, tabName) {
    ...
    var tabContents = document.getElementsByClassName('item-card--container__size-chart');
    for (var i = 0; i < tabContents.length; i++) {
        tabContents[i].style.display = "none";
    }

    // Remove the active class from all tab links
    var tabLinks = document.getElementsByClassName('item-card--container__info__button');
